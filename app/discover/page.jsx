...
export default async function Discover() {
  ...
  const visibleCats = cats.length ? cats : [{id:1,name:'Computer Skills'},{id:2,name:'Programming'},{id:3,name:'Design & Creativity'},{id:4,name:'Business'},{id:5,name:'Academic Learning'},{id:6,name:'Personal Development'}]
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <div className="container">
          ...
          <div className={styles.stats}><div><b>10K+</b><span>Learners reached</span></div><div><b>{books.length || '50'}+</b><span>Guides in the store</span></div><div><b>{cats.length || '8'}+</b><span>Learning categories</span></div><div><b>4.8★</b><span>Learning experience</span></div></div>
        </div>
      </section>
