        ...
        <div className="authShell">
          ...
          <div className="authCard authCardModern">
            ...
            <form onSubmit={submit} noValidate>
              <label>Full name<span className="authInput"><UserRound size={17} aria-hidden="true" /><input type="text" autoComplete="name" placeholder="Your full name" required value={name} onChange={e => setName(e.target.value)} /></span></label>
              <label>Phone number <span className="optional">(optional)</span><span className="authInput"><Phone size={17} aria-hidden="true" /><input type="tel" inputMode="tel" autoComplete="tel" placeholder="Your phone number" value={phone} onChange={e => setPhone(e.target.value)} /></span></label>
              ...
              <label>Password<span className="authInput"><LockKeyhole size={17} aria-hidden="true" /><input type={showPassword ? 'text' : 'password'} autoComplete="new-password" placeholder="At least 6 characters" minLength={6} required value={password} onChange={e => setPassword(e.target.value)} /><button type="button" className="passwordToggle" aria-label={showPassword ? 'Hide password' : 'Show password'} onClick={() => setShowPassword(!showPassword)}>{showPassword ? <EyeOff size={17} /> : <Eye size={17} />}</button></span></label>
