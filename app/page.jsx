    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <div className="container">
          ...
          <div className={styles.stats}><div><b>{books.length}</b><span>Featured guides</span></div><div><b>{cats.length}</b><span>Learning categories</span></div><div><b>24/7</b><span>Learn at your pace</span></div><div><b>★★★★★</b><span>Review-ready experience</span></div></div>
        </div>
      </section>
